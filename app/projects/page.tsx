...
const projects = [
  { number:"01", kind:"Personal technical project", title:"Engineering Analytics Platform", description:"A React-based platform designed to analyze activity across multiple GitLab repositories and convert repository activity into operational reporting for engineering leaders.", challenge:"Surface delivery health, development activity, defect trends, and status insights across multiple repositories.", approach:"Explored API integrations, caching strategies, data persistence, and AI-assisted analysis.", outcome:"A platform concept centered on operational reporting for engineering leaders.", tools:["React","GitLab APIs","Data persistence","Caching","AI analysis"] },
  { number:"02", kind:"Enterprise engineering initiative", title:"AI-Assisted Engineering Discovery", description:"Applied GitHub Copilot and LLMs across production repositories during an enterprise platform transformation.", challenge:"Accelerate technical discovery and requirements validation across production repositories.", approach:"Used AI-assisted engineering analysis alongside architecture, data-flow, payload, and integration-behavior review.", outcome:"Accelerated technical discovery and requirements validation while supporting executive-ready technology decisions.", tools:["GitHub Copilot","LLMs","Repository analysis","Requirements","Architecture"] },
