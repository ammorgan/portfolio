...
const roles = [
  { dates:"Aug 2025–Present", title:"Sales Lead · MernaPAS Platform Transformation", points:["Lead enterprise platform transformation across vendor engineers, internal developers, architects, QA, and business stakeholders.","Define technical scope, remove blockers, and maintain executive visibility across dependencies, defects, readiness, and risk.","Pioneered AI-assisted engineering analysis across production repositories using GitHub Copilot and LLMs."] },
  { dates:"Dec 2022–Jul 2025", title:"Horizontal Product Owner · Shopping Journey Auto", points:["Led delivery of the Simplified Auto Sales Agency UI, generating 2.5M quotes in 2024 and increasing purchases 53% versus Policy Center.","Built a multi-year product and engineering roadmap supporting platform modernization and scalable Sales Agency enhancements.","Partnered with architects and senior engineers to influence solution design and reduce delivery risk."] },
